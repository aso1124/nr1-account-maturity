...
Account Maturity provides a quick view into the quality of your New Relic implementation. It measures key governance areas such as:

- instrumentation coverage
- alert coverage
- tag usage

Account Maturity generates scored results in these, and other, categories for configurable collections of your New Relic data. Use these scores to identify and remediate critical gaps in your observability.
